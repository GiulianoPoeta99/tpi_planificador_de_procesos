...
class EjecutorFCFS(EjecutorProcesosStrategy):
    ...
    def actualizar_cola_listos(self):
        for proceso in self.planificador.procesos:
            if proceso.tiempo_de_arribo == self.unidad_de_tiempo:
                proceso_en_ejecucion = ProcesoEnEjecucion(
                    id=proceso.id,
                    nombre=proceso.nombre,
                    tiempo_de_arribo=proceso.tiempo_de_arribo,
                    duracion_rafaga_cpu=proceso.duracion_rafaga_cpu,
                    duracion_rafaga_io=proceso.duracion_rafaga_io,
                    ...
                    cantidad_de_rafagas_io=proceso.cantidad_de_rafagas_io
                )
                self.cola_listos.append(proceso_en_ejecucion)
